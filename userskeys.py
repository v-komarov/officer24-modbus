...
class KeysNT(wx.aui.AuiMDIChildFrame):
    def __init__(self, parent):
        wx.aui.AuiMDIChildFrame.__init__(self, parent, -1, title=u"Ключи")
        ...
        sizer_1 = wx.BoxSizer(wx.HORIZONTAL)
        self.ctrl0 = ListNT(self, -1, style=wx.LC_REPORT|wx.LC_SORT_ASCENDING)
        sizer_1.Add(self.ctrl0,0)
...
#### --- Элемент со списком  ----
class ListNT(wx.ListCtrl,listmix.ListCtrlAutoWidthMixin,listmix.TextEditMixin):
